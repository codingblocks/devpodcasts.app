  ...
  plugins: [
    'gatsby-plugin-react-helmet',
    {
      ...
      options: {
        ...
        individualUrl: 'https://podcasts.search.windows.net/indexes/podcasts/docs?api-version=2017-11-11&searchFields=podcastTitle&$top=10'
      }
    }
  ]
}
